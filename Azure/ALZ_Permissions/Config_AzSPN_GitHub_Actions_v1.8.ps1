function Setup-AzureSpn {
    <#
        ...
        Number of days until the client secret expires. Default is 365.
        ...
        PS> . ./Config_AzSPN_GitHub_Actions_v1.8.ps1
    ...
    param (
        ...
        [Parameter(Mandatory = $false, HelpMessage = "Number of days until the client secret expires. Default is 365.")]
        [int]$azSpnSecretExpiryInDays = 365,

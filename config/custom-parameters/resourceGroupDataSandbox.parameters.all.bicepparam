...
var varRgNameInfra01 = '${varAzUkAbbrName}${varAzUks}-RG-${varSnd}--01'
var varRgNameInfra02 = '${varAzUkAbbrName}${varAzUks}-RG-${varSnd}--01'
var varRgNameInfra03 = '${varAzUkAbbrName}${varAzUks}-RG-${varSnd}--01'

...
var varRgNameInfra01 = '${varAzUkAbbrName}${varAzUks}-RG-${varSnd}-JMoore-01'
var varRgNameInfra02 = '${varAzUkAbbrName}${varAzUks}-RG-${varSnd}-AGrobier-01'
var varRgNameInfra03 = '${varAzUkAbbrName}${varAzUks}-RG-${varSnd}-PByrne-01'

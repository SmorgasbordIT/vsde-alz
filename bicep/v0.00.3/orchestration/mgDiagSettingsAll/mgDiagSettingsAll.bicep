...
var varLandingZoneMgCustomChildren = [for customMg in parLandingZoneMgChildren: {
  mgId: '${parTopLevelManagementGroupPrefix}-alz-${customMg}${parTopLevelManagementGroupSuffix}'
}]

// Used if parLandingZoneMgConfidentialEnable not empty
var varPlatformMgCustomChildren = [for customMg in parPlatformMgChildren: {
  mgId: '${parTopLevelManagementGroupPrefix}-plat-${customMg}${parTopLevelManagementGroupSuffix}'
}]
...
module modMgDiagSet '../../../../upstream-releases/v0.22.0/infra-as-code/bicep/modules/mgDiagSettings/mgDiagSettings.bicep' = [for mgId in items(varMgIds): {
...
module modMgLandingZonesDiagSet '../../../../upstream-releases/v0.22.0/infra-as-code/bicep/modules/mgDiagSettings/mgDiagSettings.bicep' = [for childMg in items(varLandingZoneMgDefaultChildrenUnioned): {
...
module modMgPlatformDiagSet '../../../../upstream-releases/v0.22.0/infra-as-code/bicep/modules/mgDiagSettings/mgDiagSettings.bicep' = [for childMg in items(varPlatformMgDefaultChildrenUnioned): {
  scope: managementGroup(childMg.value)
  name: 'mg-diag-set-${childMg.value}'
  params: {
    parLogAnalyticsWorkspaceResourceId: parLogAnalyticsWorkspaceResourceId
...
module modMgChildrenDiagSet '../../../../upstream-releases/v0.22.0/infra-as-code/bicep/modules/mgDiagSettings/mgDiagSettings.bicep' = [for childMg in varLandingZoneMgCustomChildren: {
...
module modPlatformMgChildrenDiagSet '../../../../upstream-releases/v0.22.0/infra-as-code/bicep/modules/mgDiagSettings/mgDiagSettings.bicep' = [for childMg in varPlatformMgCustomChildren: {
  scope: managementGroup(childMg.mgId)
  name: 'mg-diag-set-${childMg.mgId}'
  params: {
    parLogAnalyticsWorkspaceResourceId: parLogAnalyticsWorkspaceResourceId

...
<img src="./media/alzPolicyAzAdvertizer.png" width="1000">
...
<img src="./media/MgmtGrp_Policies_v0.1.jpg" width="1000">
...
<img src="./media/azuk-snk-int-root.jpg" width="400">
...
The table below provides the specific **Custom** and **Built-in** **policy definitions** and **policy definitions sets** assigned at the **AZUK-SNK Management Group (Intermediate Root)**.
...
The table below provides the specific **Custom** and **Built-in** **policy definitions** and **policy definitions sets** assigned at the **AZUK-SNK-Connectivity Management Group**.
